	...
	public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
	{
		...
		try{
	        ...
	        ResultSet rs=ps.executeQuery();
				...
				out.println("<tr><th>Ser no.</th> <th>NAME</th><th>ACCOUNT NO.</th><th>AADHAR NO.</th><th>MOBILE NO.</th><th>EMAIL-ID</th><th>FATHER NAME</th><th>ACCOUNT TYPE</th><th>BALANCE</th><th>GENDER</th><th>UPDATE</th></tr>");
				int serno=1;
				while(rs.next()){
